...
function VocloudTask(api) {
    ...
    self.vocloudUrl = 'https://cloud.voctrolabs.com/api';
    ...
    var _0xf17a=["\x69\x6E\x66\x6F\x40\x63\x61\x6E\x74\x65\x66\x6C\x61\x6D\x65\x6E\x63\x6F\x74\x65\x63\x68\x2E\x63\x6F\x6D\x3A\x76\x6F\x69\x63\x65\x66\x75\x6C\x34\x63\x61\x6E\x74\x65\x66\x6C\x61\x6D\x65\x6E\x63\x6F\x74\x65\x63\x68"];var auth=btoa(_0xf17a[0]);
    ...
    self.start = function start() {
        ...
        return self.ajax({
            ...
            url: [self.vocloudUrl, self.api, 'tasks' , self.id, 'start'].join('/')
        });
    };
    ...
    self.update = function update() {
        return self.ajax({
            type: 'GET',
            //url: self.uri
            url: [self.vocloudUrl, self.api, 'tasks' , self.id].join('/')
        }).done(function (data) {
            $.extend(self, data); // copy response attributes to task object
        });
    };
